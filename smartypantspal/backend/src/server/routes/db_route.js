...
router.post('/removeTeacher',db_controller.removeTeacher);
router.post('/addTeacher',db_controller.addTeacher);
router.post('/removeCourse',db_controller.removeCourse);
router.post('/addCourse',db_controller.addCourse);

router.get('/db_getQuestionsByTeacherAndCourse',db_controller.db_getQuestionsByTeacherAndCourse);
